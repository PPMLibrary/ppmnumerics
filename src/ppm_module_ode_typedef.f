...
integer, parameter :: ode_state_kickoff   = 1
...
subroutine ode_create(this,scheme,fields,rhsfunc,rhs_fields,info,kickoff_scheme)
  ...
  case(ppm_param_ode_scheme_eulerf)
    ...
    call this%integrator%create(fields,rhsfunc,rhs_fields,info)
  case default
  ...
  if (kickoff.eq.scheme) then
    ...
    case(ppm_param_ode_scheme_eulerf)
      ...
      call this%kickoff%create(fields,rhsfunc,rhs_fields,info)
    case default
      ppm_fail("Integrator not implemented")
    end select
  end if
